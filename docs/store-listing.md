...
• See an estimated live delay for overdue assignments that have no final submission yet, on assignment badges, course totals, and delay budgets; the estimate is kept separate from consumed delay and remaining capacity.
