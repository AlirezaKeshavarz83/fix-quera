...
- Removed the standalone live-delay bucket metric and added a CSS hover tooltip on the live-delay segment showing its total duration for unsubmitted assignments.
